  ...
  return (
    ...
    >
      <div className="w-full h-full flex flex-col justify-start text-center content-center p-8">
        ...
        <form>
            <input name="login" type="email" className="border-2 border-slate-400 rounded-xl w-full h-12 p-2 mb-4" placeholder="Почта"></input>
            <input name="password" type="password" className="border-2 border-slate-400 rounded-xl w-full h-12 p-2 mb-8" placeholder="Пароль"></input>
            <div className=" content-center font-medium text-base">
                <Button onClick={() => dispatch(switchVisible())} size="2.5rem" color="black" type={'Войти'} className="border-2 text-white bg-slate-800 border-slate-800 rounded-xl w-full h-12 p-2 mb-4"/>
                <Button onClick={() => dispatch(switchVisible())} size="2.5rem" color="black" type={'Зарегистрироваться'} className="border-2 border-slate-600 rounded-xl w-full h-12 p-2 mb-4"/>
            </div>
        </form>
