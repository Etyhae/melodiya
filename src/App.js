...
import { CurrentTrack } from "./style/styles";
...
function App() {
  ...
  const skipSong = (way) => {
    setSong(
      (songCurrent) => playlistCurrent.songs[playlistCurrent.songs.indexOf(songCurrent) + way]
    );
  };
  ...
  return (
    <div>
      <PlaylistAside isHidden={isHidden} playlist={playlistCurrent} songCurrent={songCurrent} songSwitch={songSwitch}/>
